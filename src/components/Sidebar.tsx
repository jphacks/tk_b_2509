...
export default function Sidebar() {
  ...
  return (
    <aside className="hidden md:fixed md:left-0 md:top-0 md:h-screen md:bg-white md:flex md:flex-col md:gap-2 md:z-50 md:w-20 md:border-r md:border-slate-200 md:items-center md:p-2 lg:w-24">
